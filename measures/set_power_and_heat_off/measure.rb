  ...
  def run(model, runner, user_arguments)
    ...
    if otg_type == 'Power and Heat'
      model.getScheduleRulesets.each do |schedule_ruleset|
        ...
        next if schedule_ruleset.name.to_s.include?('ACTIVITY') || schedule_ruleset.name.to_s.include?('Activity') || schedule_ruleset.name.to_s.include?('Activity')
        next if schedule_ruleset.name.to_s.include?('Clothing') || schedule_ruleset.name.to_s.include?('CLOTHING') || schedule_ruleset.name.to_s.include?('Air Velocity Schedule')         
        next if schedule_ruleset.name.to_s.include?('Infiltration') || schedule_ruleset.name.to_s.include?('CLOTHING') || schedule_ruleset.name.to_s.include?('Air Velocity Schedule') 
