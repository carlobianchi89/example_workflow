...
# start the measure
class SwapACMSchedules < OpenStudio::Ruleset::ModelUserScript
  # display name
  def name
    'swap_ACM_schedules'
  end
  ...
  # description
  def description
    'This measure changes original Prototype Buildings schedules with ACM schedules for the 179D project'
  end
...
SwapACMSchedules.new.registerWithApplication
